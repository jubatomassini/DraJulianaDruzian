...
export const site = {
  ...
  description:
    "Reumatologista (RQE 8985) em Sinop–MT, na Clínica Cimed. Atendimento humanizado " +
  ...
  crm: process.env.NEXT_PUBLIC_CRM ?? "CRM MT 17963",
  rqe: process.env.NEXT_PUBLIC_RQE ?? "RQE 8985",
  mapsEmbedUrl:
